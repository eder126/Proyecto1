...
//        
//function aceptar(){
//	if(document.getElementById("tituloAdv").innerHTML == "Éxito"){
...
//				nuevo.innerHTML = `<a href="${item.href}">${item.opcion}</a>`;
//				document.getElementById("contenidoDropdown").appendChild(nuevo);
...
//
//		} else {
//			document.getElementById("menu2").innerHTML = "<a class='registrarLogin' href='./registrar'>Registrar</a> <a class='registrarLogin' href='./login'>Login</a>";
//		}
//
//
//
